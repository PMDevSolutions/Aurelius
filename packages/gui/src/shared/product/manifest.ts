 ...
 *
 * This is the seam that turns the shell from "the Aurelius app" into a generic
 ...
 * lives in the per-product manifest object (see ./aurelius). A second product
