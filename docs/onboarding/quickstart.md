...
When you work with Claude Code in this repository, **56 specialized agents** are available automatically. You do not need to invoke them manually -- Claude Code selects the right agent based on your task.
